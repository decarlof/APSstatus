        ...
        Task {
            do {
                ...
                let (parsedItems, status) = try await Task.detached(priority: .userInitiated) { () -> ([(String,String)], String) in
                    ...
                    let parsed = try parseAllParamsItems(decompressed)
...
// MARK: - Pure parsing helper (runs off-main)
func parseAllParamsItems(_ data: Data) throws -> [(description: String, value: String)] {
    var offset = 0
